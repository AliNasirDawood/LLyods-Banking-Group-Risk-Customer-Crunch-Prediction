...
def plot_sunburst(df, path_columns, title, color_column=None):
    """
    Generic function to plot a sunburst chart.
    :param df: DataFrame containing the data
    :param path_columns: List of columns representing the hierarchy (e.g., ['ChurnStatus', 'AgeGroup', 'Gender', 'MaritalStatus', 'IncomeLevel'])
    :param title: Title of the plot
    :param color_column: Column for color differentiation (optional)
    :return: Plotly figure
    """
